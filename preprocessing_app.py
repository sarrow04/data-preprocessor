...
if st.session_state.df is not None:
    ...
    if selected_target != "---":
        ...
        st.multiselect("予測に使う「説明変数」を1つ以上選択してください", ["まず目的変数を選択してください"])
